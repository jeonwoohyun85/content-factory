...
### 📋 상세 타임라인
- **2026-01-31 08:42** ♻️ [refactor] 주간 요약 → 월별 요약으로 변경
- **2026-01-31 08:42** ♻️ [refactor] 주간→월별 요약 워크플로우로 변경
- **2026-01-31 08:55** 📝 [docs] 기술 스택 진화 섹션 제거 (자동 누적 불가)
- **2026-01-31 09:10** ✨ [feature] Umami 컬럼 추가 (우마미, 우마미공유)
- **2026-01-31 09:21** 🐛 [fix] Umami 동적 Website ID 누락 수정
- **2026-01-31 09:25** 🐛 [fix] Umami 매핑 문법 오류 수정
