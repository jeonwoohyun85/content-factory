...
export async function generatePostPage(client, post, env) {
...
export async function generateClientPage(client, debugInfo, env) {
...
export async function deletePost(subdomain, createdAt, password, env) {
