...
export async function getFolderImagesForPosting(subdomain, folderName, accessToken, env, logs) {
...
export async function getClientFoldersForPosting(folderName, subdomain, accessToken, env, logs) {
...
export async function getLastUsedFolderForPosting(subdomain, accessToken, env) {
...
export function getNextFolderForPosting(folders, lastFolder) {
